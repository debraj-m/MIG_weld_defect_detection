...
model = YOLO(r"C:\Users\debra\Desktop\Dataset\Result from Github Dataset\From test dataset\weights\best.pt")  # Make sure best.pt is in the same directory or give full path

# Path to your input image
image_path = r"C:\Users\debra\Desktop\Dataset\images\train\25_35.jpg"  # <-- Change to your image path

# Run prediction
results = model.predict(
    source=image_path,
    conf=0.1,        # Lower threshold to ensure detections appear
