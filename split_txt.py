#Automates the process of splitting a dataset into train, validation, and test sets,
# converting YOLO format labels to TXT format, and organizing them into respective folders.
import os
import shutil
import random
